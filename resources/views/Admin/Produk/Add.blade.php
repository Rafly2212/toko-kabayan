      ...
      <div class="col-lg-12">
          <div class="card">
              <div class="card-header">
                  ...
                  <br>
                  Form tambah produk toko kabayan
              </div>
                  ...
                  <form action="{{route ('Produks.store')}}" class="row g-3" method="POST" enctype="multipart/form-data">
                    @csrf
                      <div class="col-md-6">
                        ...
                        <input name="nama_barang" type="text" class="form-control @error('nama_barang') is-invalid @enderror" value="{{old('nama_barang')}}" id="inputNamaBarang" placeholder="Ex.Kue Bolu" autofocus>
                        @error('nama_barang')
